...
function piechart(sample){
  ...
  d3.json("/samples/" + sample).then(function(data){
    console.log('Pie Chart function start');
  // console.log(data);
  ...
  // console.log("pielabels " + pie_labels) ;
  // console.log("pievalues " + pie_values) ;
  // console.log("piehover " + pie_hover) ;
  var trace1 = [{
    values: pie_values,
    labels: pie_labels,
    hovertext: pie_hover,
